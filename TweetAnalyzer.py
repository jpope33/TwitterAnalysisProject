...
def main():
    T=TwitterAnalysis()
    if tweetAnalysisVolume != 0:
        choice = input("Type 1 for Time Analysis of User Tweets. \n"
                       "Type 2 for Common Words used by user. \n"
                       "Type 3 to Search another user. \n"
                       "Type 4 to exit. \n")
